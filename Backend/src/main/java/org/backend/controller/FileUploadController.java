...
public class FileUploadController {
    ...
    public ResponseEntity<?> handleFileUpload(@PathVariable("tacticName") String tacticName,
        ...
        try {
            ...
            if ("maintain_multiple_copies".equalsIgnoreCase(tacticName) || "ping_echo".equalsIgnoreCase(tacticName) || "maintain_data_confidentiality".equalsIgnoreCase(tacticName) || "id_password_authentication".equalsIgnoreCase(tacticName) || "onetime_password".equalsIgnoreCase(tacticName))  {
