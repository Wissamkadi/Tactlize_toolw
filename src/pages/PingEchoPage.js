...
const translationsData = {
  en: {
    title: 'Ping Echo<span class="colored-word">Tactic</span>',
  ...
  fr: {
    title: 'Tactique Ping Echo<span class="colored-word">Tactic</span>',
